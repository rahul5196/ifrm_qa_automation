...
public class NegativeDormantAccTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateDormantAccRuleForNegativeScenarios() {
    ...
    public void theDormantAccRuleIsOnForNegativeScenarios() {
    ...
    public void checkTheDormantAccRuleIsActiveOrNotForNegativeScenarios() {
    ...
    public void iPostTransactionForDormantAccForNegativeScenarios() {
        IBMBTxn ibmbTxn =  new IBMBTxn(txnId1,currentDate + " " + currentTime,"000008","800000",20000.00,currentDate + " " + currentTime,"Test","7000583101","INR","500000","FRM NEFT TEST","","111.91.231.192","NEFT","CITI0000003","","jashantiwari25@gmail.com", 28.613939,77.209023,"INR","A|CITIBANK NA","","","","mbx");
    ...
    @And("If i get action as {string} for DormantAcc for negative scenarios")
    public void ifIGetActionAsForDormantAccForNegativeScenarios(String arg0) {
        IBMBTxn ibmbTxn =  new IBMBTxn(txnId1,currentDate + " " + currentTime,"000009","900000",20000.00,currentDate + " " + currentTime,"Test","7000583101","INR","500000","FRM NEFT TEST","","111.91.231.192","NEFT","CITI0000003","","jashantiwari25@gmail.com", 28.613939,77.209023,"INR","A|CITIBANK NA","","","","mbx");
        HashMap<String, Object> ibmbBeneficiary3 = TxnBody.IBMBTransactionBody(ibmbTxn);
        given().contentType(ContentType.JSON).
                with().body(ibmbBeneficiary3).
                when().post(postUrl).
    ...
    public void iTurnOffTheDormantAccRuleForNegativeScenarios() {
        given().cookies(authorization, token).
                when().put(RuleOperations.ecomActivateRule(ruleId)).
                then().statusCode(200);
