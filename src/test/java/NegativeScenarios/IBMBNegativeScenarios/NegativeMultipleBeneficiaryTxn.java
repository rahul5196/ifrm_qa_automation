...
public class NegativeMultipleBeneficiaryTxn extends PageObject {
    @Managed
    WebDriver webDriver;
    ...
    public void iLoginAsSupervisorToActivateMultipleBeneficiaryRuleForNegativeScenarios() {
    ...
    public void theMultipleBeneficiaryRuleIsOnForNegativeScenarios() {
    ...
    public void checkTheMultipleBeneficiaryRuleIsActiveOrNotForNegativeScenarios() {
    ...
    public void iPostTransactionForMultipleBeneficiaryForNegativeScenarios() {
    ...
    @And("If i get action as {string} for MultipleBeneficiary for negative scenarios")
    public void ifIGetActionAsForMultipleBeneficiaryForNegativeScenarios(String arg0) {
    ...
    public void iTurnOffTheMultipleBeneficiaryRuleForNegativeScenarios() {
        given().cookies(authorization, token).
                when().put(RuleOperations.ecomActivateRule(ruleId)).
                then().statusCode(200);
