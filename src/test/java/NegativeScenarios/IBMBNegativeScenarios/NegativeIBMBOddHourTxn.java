...
public class NegativeIBMBOddHourTxn extends PageObject {
    @Managed
    WebDriver webDriver;
    ...
    public void iLoginAsSupervisorToActivateIBMBOddHourRuleForNegativeScenarios() {
    ...
    public void theIBMBOddHourRuleIsOnForNegativeScenarios() {
    ...
    public void checkTheIBMBOddHourRuleIsActiveOrNotForNegativeScenarios() {
    ...
    public void iPostTransactionForIBMBOddHourForNegativeScenarios() {
    ...
    @And("If i get action as {string} for IBMBOddHour for negative scenarios")
    public void ifIGetActionAsForIBMBOddHourForNegativeScenarios(String arg0) {
        IBMBTxn ibmbTxn1 =  new IBMBTxn(txnId1,currentDate + " " + currentTime,"000004","400000",20000.00,currentDate + " " + currentTime,"Test","7000583101","INR","5484786447","FRM NEFT TEST","","111.91.231.192","NEFT","CITI0000003","","jashantiwari25@gmail.com", 28.613939,77.209023,"INR","A|CITIBANK NA","","","","mbx");
    ...
    public void iTurnOffTheIBMBOddHourRuleForNegativeScenarios() {
        given().cookies(authorization, token).
                when().put(RuleOperations.ecomActivateRule(ruleId)).
                then().statusCode(200);
