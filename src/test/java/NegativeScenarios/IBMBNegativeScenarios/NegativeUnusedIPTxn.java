...
public class NegativeUnusedIPTxn extends PageObject {
    @Managed
    WebDriver webDriver;
    ...
    public void iLoginAsSupervisorToActivateUnusedIPRuleForNegativeScenarios() {
    ...
    public void theUnusedIPRuleIsOnForNegativeScenarios() {
    ...
    public void checkTheUnusedIPRuleIsActiveOrNotForNegativeScenarios() {
    ...
    @When("I post transaction and get action as {string} for UnusedIP for negative scenarios")
    public void iPostTransactionAndGetActionAsForUnusedIPForNegativeScenarios(String arg0) {
        IBMBTxn ibmbTxn = new IBMBTxn(txnId, currentDate + " " + currentTime, "000004", "400000", 20000.00, currentDate + " " + currentTime, "Test", "7000583101", "INR", "5484786447", "FRM NEFT TEST", "", "111.91.231.168", "NEFT", "CITI0000003", "", "jashantiwari25@gmail.com", 28.613939, 77.209023, "INR", "A|CITIBANK NA", "", "", "", "mbx");
        ...
        IBMBTxn ibmbTxn1 = new IBMBTxn(txnId, currentDate + " " + currentTime, "000004", "400000", 20000.00, currentDate + " " + currentTime, "Test", "7000583101", "INR", "5484786447", "FRM NEFT TEST", "", "111.91.231.168", "NEFT", "CITI0000003", "", "jashantiwari25@gmail.com", 28.613939, 77.209023, "INR", "A|CITIBANK NA", "", "", "", "mbx");
    ...
    public void iTurnOffTheUnusedIPRuleForNegativeScenarios() {
        given().cookies(authorization, token).
                when().put(RuleOperations.ecomActivateRule(ruleId)).
                then().statusCode(200);
