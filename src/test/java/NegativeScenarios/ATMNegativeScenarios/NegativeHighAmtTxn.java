...
public class NegativeHighAmtTxn extends PageObject {
    ...
    public void theHighAmountRuleIsOnForNegativeScenarios() {
    ...
    public void checkTheHighAmountRuleIsActiveOrNotForNegativeScenarios() {
    ...
    @io.cucumber.java.en.When("I post out of scenario high amount transaction for negative scenarios")
    public void iPostOutOfScenarioHighAmountTransactionForNegativeScenarios() {
    ...
    @And("If i get response code as {int} for HighTxnAmt for negative scenarios")
    public void ifIGetResponseCodeAsForHighTxnAmtForNegativeScenarios(int arg0) {
        ATMFinancialTxn atmFinancialTxn1 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 6000, currentDate +" "+ currentTime, txnId1, currentDate +" "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1101127", "1401008137");
    ...
    @io.cucumber.java.en.Then("I turn off the high amount rule for negative scenarios")
    public void iTurnOffTheHighAmountRuleForNegativeScenarios() {
