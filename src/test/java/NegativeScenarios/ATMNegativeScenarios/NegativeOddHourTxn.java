...
public class NegativeOddHourTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateOddHourRuleForNegativeScenarios() {
    ...
    public void theOddHourRuleIsOnForNegativeScenarios() {
    ...
    @io.cucumber.java.en.And("Check the odd hour rule is active or not for negative scenarios")
    public void checkTheOddHourRuleIsActiveOrNotForNegativeScenarios() {
    ...
    @io.cucumber.java.en.When("I post out of scenario {int} odd hour transactions for negative scenarios")
    public void iPostOutOfScenarioOddHourTransactionsForNegativeScenarios(int arg0) {
        ATMFinancialTxn atmFinancialTxn = new ATMFinancialTxn("1200", "6080140888812222", "011000", 19800, currentDate + " "+"18:29:00", txnId, currentDate + " "+"03:29:00", "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "200000", "000002");
    ...
    @And("^If i get response code as (\\d+) for OddHour for negative scenarios$")
    public void ifIGetResponseCodeAsForOddHourForNegativeScenarios(int arg0) {
        ATMFinancialTxn atmFinancialTxn1 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 15000, currentDate + " "+"18:39:00", txnId1, currentDate + " "+"03:29:00", "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "200000", "000002");
    ...
    public void iTurnOffTheOddHourRuleForNegativeScenarios() {
