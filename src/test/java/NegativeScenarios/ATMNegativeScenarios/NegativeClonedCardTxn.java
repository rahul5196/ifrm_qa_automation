...
public class NegativeClonedCardTxn extends PageObject {
    String txnId = UUID.randomUUID().toString();
    String txnId1 = UUID.randomUUID().toString();
    String ruleId = "5c6f9f75-ac90-4eef-8b61-10762db8716d";
    ...
    public void iLoginAsSupervisorToActivateClonedCardRuleForNegativeScenarios() {
    ...
    public void theClonedCardRuleIsOnForNegativeScenarios() {
    ...
    @io.cucumber.java.en.And("Check the cloned card rule is active or not for negative scenarios")
    public void checkTheClonedCardRuleIsActiveOrNotForNegativeScenarios() {
    ...
    @io.cucumber.java.en.When("I post out of scenario {int} withdrawal transactions from different Terminal ID for negative scenarios")
    public void iPostOutOfScenarioWithdrawalTransactionsFromDifferentTerminalIDForNegativeScenarios(int arg0) {
        ATMFinancialTxn atmFinancialTxn = new ATMFinancialTxn("1200", "6080140888812221", "011000", 5000, currentDate +" "+ currentTime, txnId, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "700000", "000007");
        HashMap<String, Object> cloneCard = TxnBody.ATMFinancialTxnBody(atmFinancialTxn);
    ...
    @And("^If i get response code as (\\d+) for ClonedCard for negative scenarios$")
    public void ifIGetResponseCodeAsForClonedCardForNegativeScenarios(int arg0) {
        ATMFinancialTxn atmFinancialTxn1 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 5000, currentDate +" "+ currentTime, txnId1, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "987456", "RB0058080000000", "Pune", "356", "700000", "000007");
        HashMap <String, Object> cloneCard1 = TxnBody.ATMFinancialTxnBody(atmFinancialTxn1);

        given().contentType(ContentType.JSON).
                with().body(cloneCard1).
                when().post(postURL).
                then().assertThat().body("responseCode", Is.is("000")).statusCode(200);
    }

    @Then("^I turn off the cloned card rule for negative scenarios$")
    public void iTurnOffTheClonedCardRuleForNegativeScenarios() {
