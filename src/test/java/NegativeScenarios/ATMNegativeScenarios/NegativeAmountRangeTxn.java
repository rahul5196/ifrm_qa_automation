...
public class NegativeAmountRangeTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateTxnRangeRuleForNegativeScenarios() {
    ...
    public void theTxnRangeRuleIsOnForNegativeScenarios() {
    ...
    @io.cucumber.java.en.And("Check the txn range rule is active or not for negative scenarios")
    public void checkTheTxnRangeRuleIsActiveOrNotForNegativeScenarios() {
    ...
    @io.cucumber.java.en.When("I post out of scenario multiple low amount transactions for negative scenarios")
    public void iPostOutOfScenarioMultipleLowAmountTransactionsForNegativeScenarios() {
        ATMFinancialTxn atmFinancialTxn = new ATMFinancialTxn("1200", "6080140888812222", "011000", 9000, currentDate +" "+currentTime, txnId, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1101121", "1601008123");
        ...
        ATMFinancialTxn atmFinancialTxn1 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 25000, currentDate +" "+currentTime, txnId1, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1101121", "1601008123");
        ...
        ATMFinancialTxn atmFinancialTxn2 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 9000, currentDate +" "+currentTime, txnId2, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1101121", "1601008123");
    ...
    @And("^If i get response code as (\\d+) for TxnRange for negative scenarios$")
    public void ifIGetResponseCodeAsForTxnRangeForNegativeScenarios(int arg0) {
        ATMFinancialTxn atmFinancialTxn3 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 6000, currentDate +" "+currentTime, txnId3, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1101121", "1601008123");
    ...
    public void iTurnOffTheTxnRangeRuleForNegativeScenarios() {
