...
public class NegativeLimitResetTxn extends PageObject {
    String txnId = UUID.randomUUID().toString();
    String ruleId = "71e6c3d0-8533-436f-8428-2f5538ee2c7f";
    ...
    public void iLoginAsSupervisorToActivateLimitResetRuleForNegativeScenarios() {
    ...
    public void theLimitResetRuleIsOnForNegativeScenarios() {
    ...
    @io.cucumber.java.en.And("Check the limit reset rule is active or not for negative scenarios")
    public void checkTheLimitResetRuleIsActiveOrNotForNegativeScenarios() {
    ...
    @io.cucumber.java.en.When("I post out of scenario limit reset withdrawal transaction and get response code as {int} for negative scenarios")
    public void iPostOutOfScenarioLimitResetWithdrawalTransactionAndGetResponseCodeAsForNegativeScenarios(int arg0) {
        ATMFinancialTxn atmFinancialTxn = new ATMFinancialTxn("1200", "6080140888812222", "011000", 5000, currentDate +" "+"18:49:00", txnId, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "800000", "000008");
    ...
    @Then("^I turn off the limit reset rule$ for negative scenarios")
    public void iTurnOffTheLimitResetRuleForNegativeScenarios() {
