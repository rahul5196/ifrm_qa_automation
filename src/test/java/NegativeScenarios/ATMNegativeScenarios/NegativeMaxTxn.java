...
public class NegativeMaxTxn extends PageObject {
    String txnId = UUID.randomUUID().toString();
    String txnId1 = UUID.randomUUID().toString();

    String ruleId = "9b4f864e-840f-44b1-8dab-730ffb2b7ef1";
    ...
    public void iLoginAsSupervisorToActivateMaxAmountRuleForNegativeScenarios() {
    ...
    public void theMaxAmountRuleIsOnForNegativeScenarios() {
    ...
    @io.cucumber.java.en.And("Check the max amount rule is active or not for negative scenarios")
    public void checkTheMaxAmountRuleIsActiveOrNotForNegativeScenarios() {
    ...
    @io.cucumber.java.en.When("I post out of scenario max amount transaction for negative scenarios")
    public void iPostOutOfScenarioMaxAmountTransactionForNegativeScenarios() {
        ATMFinancialTxn atmFinancialTxn = new ATMFinancialTxn("1200", "6080140888812222", "011000", 52000, currentDate +" "+ currentTime, txnId, currentDate +" "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1100000", "000011");
        HashMap<String,Object> max = TxnBody.ATMFinancialTxnBody(atmFinancialTxn);
    ...
    @And("^If i get response code as (\\d+) for MaxAmount for negative scenarios$")
    public void ifIGetResponseCodeAsForMaxAmountForNegativeScenarios(int arg0) {
        ATMFinancialTxn atmFinancialTxn1 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 27999, currentDate +" "+ currentTime, txnId1, currentDate +" "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1100000", "000011");
        HashMap <String,Object> max1 = TxnBody.ATMFinancialTxnBody(atmFinancialTxn1);
    ...
    public void iTurnOffTheMaxAmountRuleForNegativeScenarios() {
