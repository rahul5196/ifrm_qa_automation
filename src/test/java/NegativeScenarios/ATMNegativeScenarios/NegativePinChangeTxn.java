...
public class NegativePinChangeTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivatePinChangeRuleForNegativeScenarios() {
    ...
    public void thePinChangeRuleIsOnForNegativeScenarios() {
    ...
    @io.cucumber.java.en.And("Check the pin change rule is active or not for negative scenarios")
    public void checkThePinChangeRuleIsActiveOrNotForNegativeScenarios() {
    ...
    @io.cucumber.java.en.When("I post out of scenario one pin change transaction followed by withdrawal transaction for negative scenarios")
    public void iPostOutOfScenarioOnePinChangeTransactionFollowedByWithdrawalTransactionForNegativeScenarios() {
        ATMPinChangeTxn atmPinChangeTxn = new ATMPinChangeTxn("1200", "6080140222222111", "911000", 1000, currentDate +" "+ currentTime, txnId, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "111","235678", "RB0058080000000", "Pune", "356", "400000", "000004");
    ...
    @And("^If i get response code as (\\d+) for PinChange for negative scenarios$")
    public void ifIGetResponseCodeAsForPinChangeForNegativeScenarios(int arg0) {
    ...
    public void iTurnOffThePinChangeRuleForNegativeScenarios() {
