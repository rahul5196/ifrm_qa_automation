...
public class NegativeChargeBackTxn extends PageObject {
    String txnId = UUID.randomUUID().toString();
    String ruleId = "00e1c017-fef0-4acc-b6e8-4fe42a7f5e80";
    ...
    public void iLoginAsSupervisorToActivateChargebackRuleForNegativeScenarios() {
    ...
    public void theChargebackRuleIsOnForNegativeScenarios() {
    ...
    @io.cucumber.java.en.And("Check the chargeback rule is active or not for negative scenarios")
    public void checkTheChargebackRuleIsActiveOrNotForNegativeScenarios() {
    ...
    @io.cucumber.java.en.When("I post out of scenario withdrawal transaction from customer with chargeback and get response code as {int} for negative scenarios")
    public void iPostOutOfScenarioWithdrawalTransactionFromCustomerWithChargebackAndGetResponseCodeAsForNegativeScenarios(int arg0) {
        ATMFinancialTxn atmFinancialTxn = new ATMFinancialTxn("1200", "6080140888812362", "011000", 5500, currentDate +" "+ currentTime, txnId, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "600000", "000006");
        HashMap<String, Object> chargeBack = TxnBody.ATMFinancialTxnBody(atmFinancialTxn);

        given().contentType(ContentType.JSON).
                with().body(chargeBack).
                when().post(postURL).
                then().assertThat().body("responseCode", Is.is("000")).statusCode(200);
    }

    @Then("^I turn off the chargeback rule for negative scenarios$")
    public void iTurnOffTheChargebackRuleForNegativeScenarios() {
