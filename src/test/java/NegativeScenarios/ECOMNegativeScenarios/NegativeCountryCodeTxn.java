...
public class NegativeCountryCodeTxn extends PageObject {
    @Managed
    WebDriver webDriver;
    ...
    @io.cucumber.java.en.Given("I login as supervisor to activate CountryCodeTxn rule for negative scenarios")
    public void iLoginAsSupervisorToActivateCountryCodeTxnRuleForNegativeScenarios() {
    ...
    @io.cucumber.java.en.And("The CountryCodeTxn rule is on for negative scenarios")
    public void theCountryCodeTxnRuleIsOnForNegativeScenarios() {
    ...
    @io.cucumber.java.en.And("Check the CountryCodeTxn rule is active or not for negative scenarios")
    public void checkTheCountryCodeTxnRuleIsActiveOrNotForNegativeScenarios() {
    ...
    @io.cucumber.java.en.When("I post transactions from the particular country code and get response code as {int} for negative scenarios")
    public void iPostTransactionsFromTheParticularCountryCodeAndGetResponseCodeForNegativeScenarios(int args) {
        ECOMTxn ecomTxn1 = new ECOMTxn("1200", "6080140888812222", "001000", 5000, currentDate + " " + currentTime, txnId, currentDate + " " + currentTime, "300", "71020171000C", "200", "5968", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "100000", "000001");
    ...
    @io.cucumber.java.en.Then("I turn off the CountryCodeTxn rule for negative scenarios")
    public void iTurnOffTheCountryCodeTxnRuleForNegativeScenarios() {
        given().cookies(authorization, token).
                when().put(RuleOperations.ecomActivateRule(ruleId)).
                then().statusCode(200);
