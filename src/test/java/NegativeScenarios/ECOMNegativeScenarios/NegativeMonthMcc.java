...
public class NegativeMonthMcc extends PageObject {
    @Managed
    WebDriver webDriver;

    String txnId = UUID.randomUUID().toString();
    String txnId1 = UUID.randomUUID().toString();
    String ruleId = "c82bcc6d-6269-4020-8dab-ab0d086f3681";
    ...
    @io.cucumber.java.en.Given("I login as supervisor to activate MonthMcc rule for negative scenarios")
    public void iLoginAsSupervisorToActivateMonthMccRuleForNegativeScenarios() {
    ...
    @io.cucumber.java.en.And("The MonthMcc rule is on for negative scenarios")
    public void theMonthMccRuleIsOnForNegativeScenarios() {
    ...
    @io.cucumber.java.en.And("Check the MonthMcc rule is active or not for negative scenarios")
    public void checkTheMonthMccRuleIsActiveOrNotForNegativeScenarios() {
    ...
    @io.cucumber.java.en.When("I post transactions for MonthMcc for negative scenarios")
    public void iPostTransactionsForMonthMccForNegativeScenarios() {
        ECOMTxn ecomTxn = new ECOMTxn("1200", "6080140888812222", "001000", 5000, currentDate + " " + currentTime, txnId, currentDate + " " + currentTime, "356", "71020171000C", "200", "5541", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "700000", "000007");
        HashMap<String, Object> monthSub = TxnBody.ECOMPurchaseTxnBody(ecomTxn);
    ...
    @io.cucumber.java.en.And("If i get response code as {int} for MonthMcc for negative scenarios")
    public void ifIGetResponseCodeAsForMonthMccForNegativeScenarios(int arg0) {
        ECOMTxn ecomTxn1 = new ECOMTxn("1200", "6080140888812222", "001000", 5000, currentDate + " " + currentTime, txnId1, currentDate + " " + currentTime, "356", "71020171000C", "200", "5541", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "700000", "000007");
        HashMap<String, Object> monthSub1 = TxnBody.ECOMPurchaseTxnBody(ecomTxn1);
        given().contentType(ContentType.JSON).
                with().body(monthSub1).
                when().post(postUrl).
    ...
    @io.cucumber.java.en.Then("I turn off the MonthMcc rule for negative scenarios")
    public void iTurnOffTheMonthMccRuleForNegativeScenarios() {
        given().cookies(authorization, token).
                when().put(RuleOperations.ecomActivateRule(ruleId)).
                then().statusCode(200);
