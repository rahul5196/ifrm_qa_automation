...
public class NegativeDuplicateTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateDuplicateTxnRuleForNegativeScenarios() {
    ...
    public void theDuplicateTxnRuleIsOnForNegativeScenarios() {
    ...
    public void checkTheDuplicateTxnRuleIsActiveOrNotForNegativeScenarios() {
    ...
    public void iPostDuplicateTransactionsForNegativeScenarios() {
        POSTxn posTxn = new POSTxn("1200", "6080140888812222", "001000", 5000, currentDate + " " + currentTime, txnId, currentDate + " " + currentTime, "356", "71020171000C", "200", "7271", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "400000", "000004");
        ...
        POSTxn posTxn1 = new POSTxn("1200", "6080140888812222", "001000", 5000, currentDate + " " + currentTime, txnId1, currentDate + " " + currentTime, "356", "71020171000C", "200", "7272", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "400000", "000004");
    ...
    @And("If i get response code as {int} for DuplicateTxn for negative scenarios")
    public void ifIGetResponseCodeAsForDuplicateTxnForNegativeScenarios(int arg0) {
        POSTxn posTxn2 = new POSTxn("1200", "6080140888812222", "001000", 5000, currentDate + " " + currentTime, txnId2, currentDate + " " + currentTime, "356", "71020171000C", "200", "7273", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "400000", "000004");
        HashMap<String, Object> duplicate2 = TxnBody.POSPurchaseTxnBody(posTxn2);
        given().contentType(ContentType.JSON).
                with().body(duplicate2).
                when().post(postUrl).
                then().assertThat().body("responseCode", Is.is("000")).statusCode(200);

        POSTxn posTxn3 = new POSTxn("1200", "6080140888812222", "001000", 6500, currentDate + " " + currentTime, txnId3, currentDate + " " + currentTime, "356", "71020171000C", "200", "7274", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "400000", "000004");
        HashMap<String, Object> duplicate3 = TxnBody.POSPurchaseTxnBody(posTxn3);
        given().contentType(ContentType.JSON).
                with().body(duplicate3).
                when().post(postUrl).
                then().assertThat().body("responseCode", Is.is("000")).statusCode(200);
    }

    @Then("I turn off the DuplicateTxn rule for negative scenarios")
    public void iTurnOffTheDuplicateTxnRuleForNegativeScenarios() {
        given().cookie(authorization, token).
                when().put(RuleOperations.posActivateRule(ruleId)).
                then().statusCode(200);
