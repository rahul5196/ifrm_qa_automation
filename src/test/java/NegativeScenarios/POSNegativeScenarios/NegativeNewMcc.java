...
public class NegativeNewMcc extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateNewMccRuleForNegativeScenarios() {
    ...
    public void theNewMccRuleIsOnForNegativeScenarios() {
    ...
    public void checkTheNewMccRuleIsActiveOrNotForNegativeScenarios() {
    ...
    @When("I post transactions from new mcc and get response code as {int} for negative scenarios")
    public void iPostTransactionsFromNewMccAndGetResponseCodeAsForNegativeScenarios(int arg0) {
        ...
        POSTxn posTxn1 = new POSTxn("1200", "6080140888812222", "001000", 25000, currentDate + " " + currentTime, txnId1, currentDate + " " + currentTime, "356", "90", "200", "4812", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "700000", "000007");
        HashMap<String,Object> newMcc1 = TxnBody.POSPurchaseTxnBody(posTxn1);
        given().contentType(ContentType.JSON).
                with().body(newMcc1).
                when().post("http://localhost:9999/api/v1/ifrm/pos/ruleengine/json/score").
    ...
    public void iTurnOffTheNewMccRuleForNegativeScenarios() {
        given().cookie(authorization, token).
                when().put(RuleOperations.posActivateRule(ruleId)).
                then().statusCode(200);
