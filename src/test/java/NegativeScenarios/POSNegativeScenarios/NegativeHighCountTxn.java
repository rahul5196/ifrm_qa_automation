...
public class NegativeHighCountTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateHighCountTxnRuleForPosForNegativeScenarios() {
    ...
    public void theHighCountTxnRuleIsOnForPosForNegativeScenarios() {
    ...
    public void checkTheHighCountTxnRuleIsActiveOrNotForPosForNegativeScenarios() {
    ...
    @When("I post {int} transaction for pos for negative scenarios")
    public void iPostTransactionForPosForNegativeScenarios(int arg0) {
    ...
    @And("If i get response code as {int} for HighCountTxn for pos for negative scenarios")
    public void ifIGetResponseCodeAsForHighCountTxnForPosForNegativeScenarios(int arg0) {
    ...
    public void iTurnOffTheHighCountTxnForPosForNegativeScenarios() {
        given().cookie(authorization, token).
                when().put(RuleOperations.posActivateRule(ruleId)).
                then().statusCode(200);
