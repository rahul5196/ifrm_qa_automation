...
public class NegativeOddHour extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateOddHourRuleForPosForNegativeScenarios() {
    ...
    public void theOddHourRuleIsOnForPosForNegativeScenarios() {
    ...
    public void checkTheOddHourRuleIsActiveOrNotForPosForNegativeScenarios() {
    ...
    @When("I post {int} odd hour transactions for pos for negative scenarios")
    public void iPostOddHourTransactionsForPosForNegativeScenarios(int arg0) {
        POSTxn posTxn = new POSTxn("1200", "6080140888812222", "001000", 19800, currentDate + " " + "12:29:00", txnId, currentDate + " " + currentTime, "356", "71020171000C", "200", "7995", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "200000", "000002");
...
then().assertThat().body("responseCode", Is.is("000")).statusCode(200);
    ...
    @And("If i get response code as {int} for OddHour for pos for negative scenarios")
    public void ifIGetResponseCodeAsForOddHourForPosForNegativeScenarios(int arg0) {
        POSTxn posTxn1 = new POSTxn("1200", "6080140888812222", "001000", 12000, currentDate + " " + "12:45:00", txnId1, currentDate + " " + currentTime, "356", "71020171000C", "200", "7995", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "200000", "000002");
...
then().assertThat().body("responseCode", Is.is("000")).statusCode(200);
    ...
    public void iTurnOffTheOddHourRuleForPosForNegativeScenarios() {
        given().cookie(authorization, token).
                when().put(RuleOperations.posActivateRule(ruleId)).
                then().statusCode(200);
