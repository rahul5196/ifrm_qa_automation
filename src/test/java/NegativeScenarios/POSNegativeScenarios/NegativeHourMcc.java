...
public class NegativeHourMcc extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateHourMccRuleForNegativeScenarios() {
    ...
    public void theHourMccRuleIsOnForNegativeScenarios() {
    ...
    public void checkTheHourMccRuleIsActiveOrNotForNegativeScenarios() {
    ...
    public void iPostATransactionFromParticularMccForNegativeScenarios() {
        POSTxn posTxn = new POSTxn("1200","6080140888812222","001000",3500,currentDate + " " + currentTime,txnId,currentDate + " " + currentTime,"356","71020171000C","200","4128","810697","000000415430","235678","RB0058080000000","Pune","356","1100000","000011");
...
then().assertThat().body("responseCode", Is.is("000")).statusCode(200);
    ...
    @And("If i get response code as {int} for HourMcc for negative scenarios")
    public void ifIGetResponseCodeAsForHourMccForNegativeScenarios(int arg0) {
        POSTxn posTxn1 = new POSTxn("1200","6080140888812222","001000",600, currentDate + " " + currentTime,txnId1, currentDate + " " + currentTime,"356","71020171000C","200","5541","810697","000000415430","235678","RB0058080000000","Pune","356","1100000","000011");
...
then().assertThat().body("responseCode", Is.is("000")).statusCode(200);
    ...
    public void iTurnOffTheHourMccForNegativeScenarios() {
        given().cookie(authorization, token).
                when().put(RuleOperations.posActivateRule(ruleId)).
                then().statusCode(200);
