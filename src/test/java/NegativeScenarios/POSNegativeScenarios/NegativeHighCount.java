...
public class NegativeHighCount extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateHighCountRuleForPosForNegativeScenarios() {
    ...
    public void theHighCountRuleIsOnForPosForNegativeScenarios() {
    ...
    public void checkTheHighCountRuleIsActiveOrNotForPosForNegativeScenarios() {
    ...
    public void iPostHighCountTransactionForPosForNegativeScenarios() {
        POSTxn posTxn = new POSTxn("1200","6080140888812222", "001000",3500, currentDate + " " + "10:15:00", txnId, currentDate + " " + currentTime, "356","71020171000C","200","4812","810697","000000415430","235678","RB0058080000000","Pune","356","1000000","000010");
...
then().assertThat().body("responseCode", Is.is("000")).statusCode(200);
        ...
        POSTxn posTxn1 = new POSTxn("1200","6080140888812222","001000",600,currentDate + " " + "10:20:00",txnId1,currentDate + " " + currentTime,"356","71020171000C","200","5921","810697","000000415430","235678","RB0058080000000","Pune","356","1000000","000010");
...
then().assertThat().body("responseCode", Is.is("000")).statusCode(200);
    ...
    @And("If i get response code as {int} for HighCount for pos for negative scenarios")
    public void ifIGetResponseCodeAsForHighCountForPosForNegativeScenarios(int arg0) {
        POSTxn posTxn2 = new POSTxn("1200","6080140888812222","001000",3600,currentDate + " " + "10:35:00",txnId2, currentDate + " " + currentTime, "356", "71020171000C", "200", "5813", "810697","000000415430", "235678", "RB0058080000000", "Pune", "356", "1000000", "000010");
...
then().assertThat().body("responseCode", Is.is("000")).statusCode(200);
    ...
    public void iTurnOffTheHighCountForPosForNegativeScenarios() {
        given().cookie(authorization, token).
                when().put(RuleOperations.posActivateRule(ruleId)).
                then().statusCode(200);
