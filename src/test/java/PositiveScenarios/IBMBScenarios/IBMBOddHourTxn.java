...
public class IBMBOddHourTxn extends PageObject {
    @Managed
    WebDriver webDriver;
    ...
    public void iLoginAsSupervisorToActivateIBMBOddHourRule() {
    ...
    public void theIBMBOddHourRuleIsOn() {
    ...
    public void checkTheIBMBOddHourRuleIsActiveOrNot() {
    ...
    public void iPostTransactionForIBMBOddHour() {
        IBMBTxn ibmbTxn =  new IBMBTxn(txnId,currentDate + " " + "23:56:00","000004","400000",20000.00,currentDate + " " + currentTime,"Test","7000583101","INR","5484786447","FRM NEFT TEST","","111.91.231.192","NEFT","CITI0000003","","jashantiwari25@gmail.com", 28.613939,77.209023,"INR","A|CITIBANK NA","","","","mbx");
    ...
    @And("If i get action as {string} for IBMBOddHour")
    public void ifIGetActionAsForIBMBOddHour(String arg0) {
        IBMBTxn ibmbTxn1 =  new IBMBTxn(txnId1,currentDate + " " + "23:57:00","000004","400000",20000.00,currentDate + " " + currentTime,"Test","7000583101","INR","5484786447","FRM NEFT TEST","","111.91.231.192","NEFT","CITI0000003","","jashantiwari25@gmail.com", 28.613939,77.209023,"INR","A|CITIBANK NA","","","","mbx");
    ...
    public void iTurnOffTheIBMBOddHourRule() {
        given().cookies(authorization, token).
                when().put(RuleOperations.ecomActivateRule(ruleId)).
                then().statusCode(200);
