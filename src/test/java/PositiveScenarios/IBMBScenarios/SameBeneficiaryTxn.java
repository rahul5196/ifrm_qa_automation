...
public class SameBeneficiaryTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateSameBeneficiaryRule() {
    ...
    public void theSameBeneficiaryRuleIsOn() {
    ...
    public void checkTheSameBeneficiaryRuleIsActiveOrNot() {
    ...
    public void iPostTransactionForSameBeneficiary() {
        ...
        IBMBBeneficiary ibmbBeneficiary2 = new IBMBBeneficiary(currentDate + " " + currentTime,"10.212.134.38","Add",currentDate + " " + currentTime,0,0,"INR",txnId2,"000008","MBX","Savings Account","000005","HDFC22142","HDFC","ANDHERI","KRUPA DEVI","KRUPA","213354657","345345345"," 214241 ","","","","","");
    ...
    @And("If i get action as {string} for SameBeneficiary")
    public void ifIGetActionAsForSameBeneficiary(String arg0) {
    ...
    public void iTurnOffTheSameBeneficiaryRule() {
        given().cookies(authorization, token).
                when().put(RuleOperations.ecomActivateRule(ruleId)).
                then().statusCode(200);
