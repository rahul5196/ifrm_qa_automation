...
public class IBMBHIghAmountTxn extends PageObject {
    @Managed
    WebDriver webDriver;
    ...
    public void iLoginAsSupervisorToActivateIBMBHighAmountRule() {
    ...
    public void theIBMBHighAmountRuleIsOn() {
    ...
    public void checkTheIBMBHighAmountRuleIsActiveOrNot() {
    ...
    public void iPostTransactionForIBMBHighAmount() {
    ...
    @And("If i get action as {string} for IBMBHighAmount")
    public void ifIGetActionAsForIBMBHighAmount(String arg0) {
        IBMBTxn ibmbTxn1 =  new IBMBTxn(txnId1,currentDate + " " + currentTime,"000002","200000",12000.00,currentDate + " " + currentTime,"Test","7000583101","INR","5484786447","FRM NEFT TEST","","111.91.231.192","NEFT","CITI0000003","","jashantiwari25@gmail.com", 28.613939,77.209023,"INR","A|CITIBANK NA","","","","mbx");
    ...
    public void iTurnOffTheIBMBHighAmountRule() {
        given().cookies(authorization, token).
                when().put(RuleOperations.ecomActivateRule(ruleId)).
                then().statusCode(200);
