...
public class IBMBHighCountTxn extends PageObject {
    @Managed
    WebDriver webDriver;
    ...
    public void iLoginAsSupervisorToActivateIBMBHighCountRule() {
    ...
    public void theIBMBHighCountRuleIsOn() {
    ...
    public void checkTheIBMBHighCountRuleIsActiveOrNot() {
    ...
    public void iPostTransactionForIBMBHighCount() {
    ...
    @And("If i get action as {string} for IBMBHighCount")
    public void ifIGetActionAsForIBMBHighCount(String arg0) {
        IBMBTxn ibmbTxn3 =  new IBMBTxn(txnId3,currentDate + " " + currentTime,"000003","300000",20000.00,currentDate + " " + currentTime,"Test","7000583101","INR","5484786447","FRM NEFT TEST","","111.91.231.192","NEFT","CITI0000003","","jashantiwari25@gmail.com", 28.613939,77.209023,"INR","A|CITIBANK NA","","","","mbx");
        HashMap<String, Object> highCount3 = TxnBody.IBMBTransactionBody(ibmbTxn3);
        given().contentType(ContentType.JSON).
    ...
    public void iTurnOffTheIBMBHighCountRule() {
        given().cookies(authorization, token).
                when().put(RuleOperations.ecomActivateRule(ruleId)).
                then().statusCode(200);
