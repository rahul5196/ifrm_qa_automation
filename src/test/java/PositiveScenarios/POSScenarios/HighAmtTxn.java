...
public class HighAmtTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateHighAmtTxnRuleForPos() {
    ...
    public void theHighAmtTxnRuleIsOnForPos() {
    ...
    public void checkTheHighAmtTxnRuleIsActiveOrNotForPos() {
    ...
    public void iPostHighAmountTransactionForPos() {
        POSTxn posTxn = new POSTxn("1200", "6080140888812222", "001000", 56000, currentDate + " " + currentTime, txnId, currentDate + " " + currentTime, "356", "71020171000C", "200", "4812", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "800000", "000008");
...
then().assertThat().body("responseCode", Is.is("000")).statusCode(200);
    ...
    @And("If i get response code as {int} for HighAmtTxn for pos")
    public void ifIGetResponseCodeAsForHighAmtTxnForPos(int arg0) {
        POSTxn posTxn1 = new POSTxn("1200", "6080140888812222", "001000", 35000, currentDate + " " + currentTime, txnId1, currentDate + " " + currentTime, "356", "71020171000C", "200", "5094", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "800000", "000008");
...
then().assertThat().body("responseCode", Is.is("202")).statusCode(200);
    ...
    public void iTurnOffTheHighAmtTxnForPos() {
        given().cookie(authorization, token).
                when().put(RuleOperations.posActivateRule(ruleId)).
                then().statusCode(200);
