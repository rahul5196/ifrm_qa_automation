...
public class LowAmtMcc extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateLowAmtMccRule() {
    ...
    public void theLowAmtMccRuleIsOn() {
    ...
    public void checkTheLowAmtMccRuleIsActiveOrNot() {
    ...
    public void iPostLowAmountTransactionFromParticularMcc() {
        POSTxn posTxn = new POSTxn("1200", "6080140888812222", "001000", 3500, currentDate + " " + currentTime, txnId, currentDate + " " + currentTime, "356", "71020171000C", "200", "4812", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "900000", "000009");
...
then().assertThat().body("responseCode", Is.is("000")).statusCode(200);
    ...
    @And("If i get response code as {int} for LowAmtMcc")
    public void ifIGetResponseCodeAsForLowAmtMcc(int arg0) {
        POSTxn posTxn2 = new POSTxn("1200","6080140888812222", "001000", 3600, currentDate + " " + currentTime, txnId2, currentDate + " " + currentTime, "356", "71020171000C", "200", "5813", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "900000", "000009");
...
then().assertThat().body("responseCode", Is.is("202")).statusCode(200);
    ...
    public void iTurnOffTheLowAmtMcc() {
        given().cookie(authorization, token).
                when().put(RuleOperations.posActivateRule(ruleId)).
                then().statusCode(200);
