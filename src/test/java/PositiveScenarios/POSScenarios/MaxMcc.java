...
public class MaxMcc extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateMaxMccRule() {
    ...
    public void checkTheMaxMccRuleIsActiveOrNot() {
    ...
    public void iPostTransactionsFromDifferentMcc() {
    ...
    @And("If i get response code as {int} for MaxMcc")
    public void ifIGetResponseCodeAsForMaxMcc(int arg0) {
        POSTxn posTxn1 = new POSTxn("1200", "6080140888812222", "001000", 5600, currentDate + " " + currentTime, txnId1, currentDate + " " + currentTime, "356", "71020171000C", "200", "5094", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "500000", "000005");
    ...
    public void iTurnOffTheMaxMccRule() {
        given().cookie(authorization, token).
                when().put(RuleOperations.posActivateRule(ruleId)).
                then().statusCode(200);
