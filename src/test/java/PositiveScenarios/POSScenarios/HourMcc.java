...
public class HourMcc extends PageObject {

    String txnId = UUID.randomUUID().toString();
    String txnId1 = UUID.randomUUID().toString();
    String txnId2 = UUID.randomUUID().toString();
    String ruleId = "1ec73839-a7b8-43d0-8053-319da3f05696";
    ...
    @Given("I login as supervisor to activate HourMcc rule")
    public void iLoginAsSupervisorToActivateHourMccRule() {
    ...
    @And("The HourMcc rule is on")
    public void theHourMccRuleIsOn() {
    ...
    @And("Check the HourMcc rule is active or not")
    public void checkTheHourMccRuleIsActiveOrNot() {
    ...
    @When("I post a transaction from particular mcc")
    public void iPostATransactionFromParticularMcc() {
        POSTxn posTxn = new POSTxn("1200", "6080140888812222", "001000", 3500, currentDate + " " + currentTime, txnId, currentDate + " " + currentTime, "356", "71020171000C", "200", "5541", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1100000", "000011");
        HashMap<String, Object> hourMcc = TxnBody.POSPurchaseTxnBody(posTxn);
    ...
    @And("If i get response code as {int} for HourMcc")
    public void ifIGetResponseCodeAsForHourMcc(int arg0) {
        POSTxn posTxn1 = new POSTxn("1200", "6080140888812222", "001000", 2500, currentDate + " " + currentTime, txnId1, currentDate + " " + currentTime, "356", "71020171000C", "200", "5541", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1100000", "000011");
        HashMap<String, Object> hourMcc1 = TxnBody.POSPurchaseTxnBody(posTxn1);
        given().contentType(ContentType.JSON).
                with().body(hourMcc1).
                when().post(postUrl).
                then().assertThat().body("responseCode", Is.is("000")).statusCode(200);

        POSTxn posTxn2 = new POSTxn("1200", "6080140888812222", "001000", 2500, currentDate + " " + currentTime, txnId2, currentDate + " " + currentTime, "356", "71020171000C", "200", "5541", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1100000", "000011");
        HashMap<String, Object> hourMcc2 = TxnBody.POSPurchaseTxnBody(posTxn2);
        given().contentType(ContentType.JSON).
                with().body(hourMcc2).
                when().post(postUrl).
    ...
    @Then("I turn off the HourMcc")
    public void iTurnOffTheHourMcc() {
        given().cookie(authorization, token).
                when().put(RuleOperations.posActivateRule(ruleId)).
                then().statusCode(200);
