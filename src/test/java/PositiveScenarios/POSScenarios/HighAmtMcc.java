...
public class HighAmtMcc extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateHighAmtMccRule() {
    ...
    public void theHighAmtMccRuleIsOn() {
    ...
    public void checkTheHighAmtMccRuleIsActiveOrNot() {
    ...
    public void iPostHighAmountMccTransaction() {
...
then().assertThat().body("responseCode", Is.is("202")).statusCode(200);
    ...
    @And("If i get response code as {int} for HighAmtMcc")
    public void ifIGetResponseCodeAsForHighAmtMcc(int arg0) {
...
then().assertThat().body("responseCode", Is.is("202")).statusCode(200);
    ...
    public void iTurnOffTheHighAmtMcc() {
        given().cookie(authorization, token).
                when().put(RuleOperations.posActivateRule(ruleId)).
                then().statusCode(200);
