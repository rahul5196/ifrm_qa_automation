...
public class DayMccCount extends PageObject {
    ...
    @io.cucumber.java.en.Given("I login as supervisor to activate DayMccCount rule")
    public void iLoginAsSupervisorToActivateDayMccCountRule() {
    ...
    @io.cucumber.java.en.And("The DayMccCount rule is on")
    public void theDayMccCountRuleIsOn() {
    ...
    @io.cucumber.java.en.And("Check the DayMccCount rule is active or not")
    public void checkTheDayMccCountRuleIsActiveOrNot() {
    ...
    @io.cucumber.java.en.When("I post transactions from specified mcc for DayMccCount")
    public void iPostTransactionsFromSpecifiedMccForDayMccCount() {
        ECOMTxn ecomTxn = new ECOMTxn("1200", "6080140888812222", "001000", 5000, currentDate + " " + currentTime, txnId, currentDate + " " + currentTime, "356", "71020171000C", "200", "7995", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "500000", "000005");
    ...
    @io.cucumber.java.en.And("If i get response code as {int} for DayMccCount")
    public void ifIGetResponseCodeAsForDayMccCount(int arg0) {
        ECOMTxn ecomTxn = new ECOMTxn("1200", "6080140888812222", "001000", 5000, currentDate + " " + currentTime, txnId1, currentDate + " " + currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "500000", "000005");
        HashMap<String, Object> monthSubMcc = TxnBody.ECOMPurchaseTxnBody(ecomTxn);
        given().contentType(ContentType.JSON).
                with().body(monthSubMcc).
                when().post(postUrl).
    ...
    @io.cucumber.java.en.Then("I turn off the DayMccCount rule")
    public void iTurnOffTheDayMccCountRule() {
        given().cookies(authorization, token).
                when().put(RuleOperations.ecomActivateRule(ruleId)).
                then().statusCode(200);
