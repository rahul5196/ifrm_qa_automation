...
public class CatAMcc extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateCatAMccRule() {
    ...
    public void theCatAMccRuleIsOn() {
    ...
    public void checkTheCatAMccRuleIsActiveOrNot() {
    ...
    @When("I post transactions from specified mcc for CatAMcc and get response code as {int}")
    public void iPostTransactionsFromSpecifiedMccForCatAMccAndGetResponseCodeAs(int argo) {
        ECOMTxn ecomTxn = new ECOMTxn("1200", "6080140888812222", "001000", 21000, currentDate + " " + currentTime, txnId, currentDate + " " + currentTime, "356", "71020171000C", "200", "5541", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "300000", "000003");
    ...
    public void iTurnOffTheCatAMccRule() {
        given().cookies(authorization, token).
                when().put(RuleOperations.ecomActivateRule(ruleId)).
                then().statusCode(200);
