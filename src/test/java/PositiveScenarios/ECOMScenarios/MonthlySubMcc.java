...
public class MonthlySubMcc extends PageObject {
    @Managed
    WebDriver webDriver;
    ...
    @io.cucumber.java.en.Given("I login as supervisor to activate MonthlySubMcc rule")
    public void iLoginAsSupervisorToActivateMonthlySubMccRule() {
    ...
    @io.cucumber.java.en.And("The MonthlySubMcc rule is on")
    public void theMonthlySubMccRuleIsOn() {
    ...
    @io.cucumber.java.en.And("Check the MonthlySubMcc rule is active or not")
    public void checkTheMonthlySubMccRuleIsActiveOrNot() {
    ...
    @io.cucumber.java.en.When("I post transaction from the specified mcc for MonthlySubMcc")
    public void iPostTransactionFromTheSpecifiedMccForMonthlySubMcc() {
        ECOMTxn ecomTxn = new ECOMTxn("1200", "6080140888812222", "5V1000", 5000, currentDate + " " + currentTime, txnId, currentDate + " " + currentTime, "356", "71020171000C", "200", "5967", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "100000", "000001");
    ...
    @io.cucumber.java.en.And("If i get response code as {int} for MonthlySubMcc")
    public void ifIGetResponseCodeAsForMonthlySubMcc(int arg0) {
        ECOMTxn ecomTxn1 = new ECOMTxn("1200", "6080140888812222", "5V1000", 5000, currentDate + " " + currentTime, txnId1, currentDate + " " + currentTime, "356", "71020171000C", "200", "5968", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "100000", "000001");
    ...
    @io.cucumber.java.en.Then("I turn off the MonthlySubMcc rule")
    public void iTurnOffTheMonthlySubMccRule() {
        given().cookies(authorization, token).
                when().put(RuleOperations.ecomActivateRule(ruleId)).
                then().statusCode(200);
