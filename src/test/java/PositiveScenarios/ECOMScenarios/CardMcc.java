...
public class CardMcc extends PageObject {
    ...
    @io.cucumber.java.en.Given("I login as supervisor to activate CardMcc rule")
    public void iLoginAsSupervisorToActivateCardMccRule() {
    ...
    @io.cucumber.java.en.And("The CardMcc rule is on")
    public void theCardMccRuleIsOn() {
    ...
    @io.cucumber.java.en.And("Check the CardMcc rule is active or not")
    public void checkTheCardMccRuleIsActiveOrNot() {
    ...
    @io.cucumber.java.en.When("I post transactions for CardMcc")
    public void iPostTransactionsForCardMcc() {
        ECOMTxn ecomTxn = new ECOMTxn("1200", "6080140888812222", "001000", 2500, currentDate + " " + currentTime, txnId, currentDate + " " + currentTime, "356", "71020171000C", "200", "7299", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "800000", "000008");
    ...
    @io.cucumber.java.en.And("If i get response code as {int} for CardMcc")
    public void ifIGetResponseCodeAsForCardMcc(int arg0) {
        ECOMTxn ecomTxn = new ECOMTxn("1200", "6080140888812222", "001000", 3500, currentDate + " " + currentTime, txnId1, currentDate + " " + currentTime, "356", "71020171000C", "200", "7299", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "800000", "000008");
        HashMap<String, Object> cardMcc1 = TxnBody.ECOMPurchaseTxnBody(ecomTxn);
        given().contentType(ContentType.JSON).
                with().body(cardMcc1).
                when().post(postUrl).
    ...
    @io.cucumber.java.en.Then("I turn off the CardMcc rule")
    public void iTurnOffTheCardMccRule() {
        given().cookies(authorization, token).
                when().put(RuleOperations.ecomActivateRule(ruleId)).
                then().statusCode(200);
