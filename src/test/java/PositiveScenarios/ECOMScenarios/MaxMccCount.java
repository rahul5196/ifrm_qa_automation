...
public class MaxMccCount extends PageObject {
    @Managed
    WebDriver webDriver;
    ...
    @io.cucumber.java.en.Given("I login as supervisor to activate MaxMccCount rule")
    public void iLoginAsSupervisorToActivateMaxMccCountRule() {
    ...
    @io.cucumber.java.en.And("The MaxMccCount rule is on")
    public void theMaxMccCountRuleIsOn() {
    ...
    @io.cucumber.java.en.And("Check the MaxMccCount rule is active or not")
    public void checkTheMaxMccCountRuleIsActiveOrNot() {
    ...
    @io.cucumber.java.en.When("I post transaction for MaxMccCount")
    public void iPostTransactionForMaxMccCount() {
        ...
        ECOMTxn ecomTxn1 = new ECOMTxn("1200", "6080140888812222", "001000", 5000, currentDate + " " + currentTime, txnId1, currentDate + " " + currentTime, "356", "71020171000C", "200", "6540", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "900000", "000009");
    ...
    @io.cucumber.java.en.And("If i get response code as {int} for MaxMccCount")
    public void ifIGetResponseCodeAsForMaxMccCount(int arg0) {
        ECOMTxn ecomTxn2 = new ECOMTxn("1200", "6080140888812222", "001000", 5000, currentDate + " " + currentTime, txnId2, currentDate + " " + currentTime, "356", "71020171000C", "200", "6540", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "900000", "000009");
    ...
    @io.cucumber.java.en.Then("I turn off the MaxMccCount")
    public void iTurnOffTheMaxMccCount() {
        given().cookies(authorization, token).
                when().put(RuleOperations.ecomActivateRule(ruleId)).
                then().statusCode(200);
