...
public class MonthMcc extends PageObject {
    @Managed
    WebDriver webDriver;
    ...
    @io.cucumber.java.en.Given("I login as supervisor to activate MonthMcc rule")
    public void iLoginAsSupervisorToActivateMonthMccRule() {
    ...
    @io.cucumber.java.en.And("The MonthMcc rule is on")
    public void theMonthMccRuleIsOn() {
    ...
    @io.cucumber.java.en.And("Check the MonthMcc rule is active or not")
    public void checkTheMonthMccRuleIsActiveOrNot() {
    ...
    @io.cucumber.java.en.When("I post transactions for MonthMcc")
    public void iPostTransactionsForMonthMcc() {
        ECOMTxn ecomTxn = new ECOMTxn("1200", "6080140888812222", "001000", 5000, currentDate + " " + currentTime, txnId, currentDate + " " + currentTime, "356", "71020171000C", "200", "5967", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "700000", "000007");
    ...
    @io.cucumber.java.en.And("If i get response code as {int} for MonthMcc")
    public void ifIGetResponseCodeAsForMonthMcc(int arg0) {
        ECOMTxn ecomTxn1 = new ECOMTxn("1200", "6080140888812222", "001000", 5000, currentDate + " " + currentTime, txnId1, currentDate + " " + currentTime, "356", "71020171000C", "200", "5967", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "700000", "000007");
    ...
    @io.cucumber.java.en.Then("I turn off the MonthMcc rule")
    public void iTurnOffTheMonthMccRule() {
        given().cookies(authorization, token).
                when().put(RuleOperations.ecomActivateRule(ruleId)).
                then().statusCode(200);
