...
public class HighRiskTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateHighRiskCustomerRule() {
    ...
    public void theHighRiskRuleIsOn() {
    ...
    @io.cucumber.java.en.And("Check the high risk customer rule is active or not")
    public void checkTheHighRiskCustomerRuleIsActiveOrNot() {
    ...
    public void iPostAWithdrawalTransactionFromHighRiskCustomer() {
        ATMFinancialTxn atmFinancialTxn = new ATMFinancialTxn("1200", "6080140888812222", "011000", 15000, currentDate +" "+currentTime, txnId, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1400000", "000014");
    ...
    @And("^If i get response code as (\\d+) for HighRiskCustomer$")
    public void ifIGetResponseCodeAsForHighRiskCustomer(int arg0) {
        ATMFinancialTxn atmFinancialTxn1 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 12500, currentDate +" "+currentTime, txnId1, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1400000", "000014");
    ...
    public void iTurnOffTheHighRiskRule() {
