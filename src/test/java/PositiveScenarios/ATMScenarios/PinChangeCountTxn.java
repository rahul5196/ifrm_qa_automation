...
public class PinChangeCountTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateUnsucssefulPinchangeCountRule() {
    ...
    public void thePinchangeCountRuleIsOn() {
    ...
    @io.cucumber.java.en.And("Check the unsuccessful pinchnge count rule is active or not")
    public void checkTheUnsuccessfulPinchngeCountRuleIsActiveOrNot() {
    ...
    @When("^I post (\\d+) pin change transactions followed by withdrawal transaction$")
    public void iPostPinChangeTransactionsFollowedByWithdrawalTransaction(int arg0) {
        ATMPinChangeTxn atmPinChangeTxn = new ATMPinChangeTxn("1200", "6080140222222111", "011000", 0, currentDate +" "+ currentTime, txnId, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "111","235678", "RB0058080000000", "Pune", "356", "200000", "000002");
        ...
        ATMPinChangeTxn atmPinChangeTxn1 = new ATMPinChangeTxn("1200", "6080140222222111", "011000", 0, currentDate +" "+ currentTime, txnId1, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "111","235678", "RB0058080000000", "Pune", "356", "200000", "000002");
    ...
    @And("^If i get response code as (\\d+) for UnsuccessfulPinChangeCount$")
    public void ifIGetResponseCodeAsForUnsuccessfulPinChangeCount(int arg0) {
        ATMFinancialTxn atmFinancialTxn = new ATMFinancialTxn("1200", "6080140888812222", "011000", 5, currentDate +" "+currentTime, txnId2, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "200000", "000002");
    ...
    public void iTurnOffTheUnsuccessfulPinchangeCountRule() {
