...
public class BalanceEnquireTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateBalanceEnquiryRule() {
    ...
    public void theBalanceEnquiryRuleIsOn() {
    ...
    @io.cucumber.java.en.And("Check the balance enquiry rule is active or not")
    public void checkTheBalanceEnquiryRuleIsActiveOrNot() {
    ...
    public void iPostOneBalanceEnquiryTransactionFollowedByWithdrawalTransaction() {
        ...
        given().contentType(ContentType.JSON).
                ...
                when().post("http://localhost:9999/api/v1/ifrm/atm/ruleengine/transaction/balance-enquiry").
                then().statusCode(200);

        System.out.println("balenquriy posted");
    }

    @And("^If i get response code as (\\d+) for BalanceEnquiry$")
    public void ifIGetResponseCodeAsForBalanceEnquiry(int arg0) {
        ...
        given().contentType(ContentType.JSON).
                ...
                when().post("http://localhost:9999/api/v1/ifrm/atm/ruleengine/json/transaction-type/cash-withdrawal/score").
                then().assertThat().body("responseCode", Is.is("202")).statusCode(200);
    }

    @Then("^I turn off the balance enquiry rule$")
    public void iTurnOffTheBalanceEnquiryRule() {
