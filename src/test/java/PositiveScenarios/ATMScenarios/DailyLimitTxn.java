...
public class DailyLimitTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateDailyLimitRule() {
    ...
    public void theDailyLimitRuleIsOn() {
    ...
    @io.cucumber.java.en.And("Check the daily limit rule is active or not")
    public void checkTheDailyLimitRuleIsActiveOrNot() {
    ...
    public void iPostDailyLimitTransaction() {
    ...
    @And("^If i get response code as (\\d+) for DailyLimit$")
    public void ifIGetResponseCodeAsForDailyLimit(int arg0) {
        ATMFinancialTxn atmFinancialTxn1 = new ATMFinancialTxn("1200", "6080142355246354", "011000", 16000, currentDate +" "+ currentTime, txnId1, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "500000", "000005");
    ...
    public void iTurnOffTheDailyLimitRule() {
