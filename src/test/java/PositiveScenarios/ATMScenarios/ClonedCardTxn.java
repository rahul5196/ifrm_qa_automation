...
public class ClonedCardTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateClonedCardRule() {
    ...
    public void theClonedCardRuleIsOn() {
    ...
    @io.cucumber.java.en.And("Check the cloned card rule is active or not")
    public void checkTheClonedCardRuleIsActiveOrNot() {
    ...
    @When("^I post (\\d+) withdrawal transactions from different Terminal ID$")
    public void iPostWithdrawalTransactionsFromDifferentTerminalID(int arg0) {
        ATMFinancialTxn atmFinancialTxn = new ATMFinancialTxn("1200", "6080140888812222", "011000", 5000, currentDate +" "+ currentTime, txnId, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "700000", "000007");
    ...
    @And("^If i get response code as (\\d+) for ClonedCard$")
    public void ifIGetResponseCodeAsForClonedCard(int arg0) {
    ...
    public void iTurnOffTheClonedCardRule() {
