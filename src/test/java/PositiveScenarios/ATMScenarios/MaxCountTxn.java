...
public class MaxCountTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateMaxCountRule() {
    ...
    public void theMaxCountRuleIsOn() {
    ...
    @io.cucumber.java.en.And("Check the max count rule is active or not")
    public void checkTheMaxCountRuleIsActiveOrNot() {
    ...
    @When("^I post (\\d+) withdrawal transactions$")
    public void iPostWithdrawalTransactions(int arg0) {
        ...
        HashMap<String, Object> maxCount = TxnBody.ATMFinancialTxnBody(atmFinancialTxn);
        ...
        ATMFinancialTxn atmFinancialTxn1 = new ATMFinancialTxn("1200", "5085240888812222", "011000", 5000, currentDate +" "+currentTime, txnId1, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "900000", "000009");
        HashMap <String, Object> maxCount1 = TxnBody.ATMFinancialTxnBody(atmFinancialTxn1);
        ...
        HashMap <String, Object> maxCount2 = TxnBody.ATMFinancialTxnBody(atmFinancialTxn2);
        ...
        HashMap <String, Object> maxCount3 = TxnBody.ATMFinancialTxnBody(atmFinancialTxn3);
        ...
        HashMap <String, Object> maxCount4 = TxnBody.ATMFinancialTxnBody(atmFinancialTxn4);
        ...
        HashMap <String, Object> maxCount5 = TxnBody.ATMFinancialTxnBody(atmFinancialTxn5);
        ...
        ATMFinancialTxn atmFinancialTxn6 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 5000, currentDate +" "+currentTime, txnId6, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "900000", "000009");
        HashMap <String, Object> maxCount6 = TxnBody.ATMFinancialTxnBody(atmFinancialTxn6);
    ...
    @And("^If i get response code as (\\d+) for MaxCount$")
    public void ifIGetResponseCodeAsForMaxCount(int arg0) {
        ATMFinancialTxn atmFinancialTxn7 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 5000, currentDate +" "+currentTime, txnId7, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "900000", "000009");
        HashMap <String, Object> maxCount7 = TxnBody.ATMFinancialTxnBody(atmFinancialTxn7);
    ...
    public void iTurnOffTheMaxCountRule() {
