...
public class BinCountTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateBinCountTxnRule() {
    ...
    public void theTxnCountRuleIsOn() {
    ...
    @io.cucumber.java.en.And("Check the bin count txn rule is active or not")
    public void checkTheBinCountTxnRuleIsActiveOrNot() {
    ...
    @When("^I post with specific bin (\\d+) withdrawal transaction$")
    public void iPostWithSpecificBinWithdrawalTransaction(int arg0) {
        ATMFinancialTxn atmFinancialTxn = new ATMFinancialTxn("1200", "6080140888812222", "011000", 5000, currentDate +" "+currentTime, txnId, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1000000", "000010");
        ...
        ATMFinancialTxn atmFinancialTxn1 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 5000, currentDate +" "+currentTime, txnId1, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1000000", "000010");
        ...
        ATMFinancialTxn atmFinancialTxn2 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 5000, currentDate +" "+currentTime, txnId2, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1000000", "000010");
        ...
        ATMFinancialTxn atmFinancialTxn3 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 5000, currentDate +" "+currentTime, txnId3, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1000000", "000010");
        ...
        ATMFinancialTxn atmFinancialTxn4 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 5000, currentDate +" "+currentTime, txnId4, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1000000", "000010");
        ...
        ATMFinancialTxn atmFinancialTxn5 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 5000, currentDate +" "+currentTime, txnId5, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1000000", "000010");
        ...
        ATMFinancialTxn atmFinancialTxn6 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 5000, currentDate +" "+currentTime, txnId6, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1000000", "000010");
    ...
    @And("^If i get response code as (\\d+) for BinCountTxn$")
    public void ifIGetResponseCodeAsForBinCountTxn(int arg0) {
        ATMFinancialTxn atmFinancialTxn7 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 5000, currentDate +" "+currentTime, txnId7, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1000000", "000010");
    ...
    public void iTurnOffTheBinCountTxnRule() {
