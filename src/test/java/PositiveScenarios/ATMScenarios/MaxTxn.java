...
public class MaxTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateMaxAmountRule() {
    ...
    public void theMaxAmountRuleIsOn() {
    ...
    @io.cucumber.java.en.And("Check the max amount rule is active or not")
    public void checkTheMaxAmountRuleIsActiveOrNot() {
    ...
    public void iPostMaxAmountTransaction() {
    ...
    @And("^If i get response code as (\\d+) for MaxAmount$")
    public void ifIGetResponseCodeAsForMaxAmount(int arg0) {
        ATMFinancialTxn atmFinancialTxn1 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 35500, currentDate +" "+ currentTime, txnId1, currentDate +" "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1100000", "000011");
    ...
    public void iTurnOffTheMaxAmountRule() {
