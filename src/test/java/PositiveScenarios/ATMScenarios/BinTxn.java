...
public class BinTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateBinTxnRule() {
    ...
    @io.cucumber.java.en.And("Check the bin txn rule is active or not")
    public void checkTheBinTxnRuleIsActiveOrNot() {
    ...
    public void iPostHighAmountWithSpecificBinWithdrawalTransaction() {
        ATMFinancialTxn atmFinancialTxn = new ATMFinancialTxn("1200", "6080140888812222", "011000", 20000, currentDate + " " + currentTime, txnId, currentDate + " " + currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1200000", "000012");
    ...
    @And("^If i get response code as (\\d+) for BinTxn$")
    public void ifIGetResponseCodeAsForBinTxn(int arg0) {
        ATMFinancialTxn atmFinancialTxn1 = new ATMFinancialTxn("1200", "6080140888812222", "011000", 12500, currentDate + " " + currentTime, txnId1, currentDate + " " + currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "1200000", "000012");
    ...
    public void iTurnOffTheBinTxnRule() {
