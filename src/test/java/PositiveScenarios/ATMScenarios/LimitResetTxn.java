...
public class LimitResetTxn extends PageObject {
    ...
    public void iLoginAsSupervisorToActivateLimitResetRule() {
    ...
    public void theLimitResetRuleIsOn() {
    ...
    @io.cucumber.java.en.And("Check the limit reset rule is active or not")
    public void checkTheLimitResetRuleIsActiveOrNot() {
    ...
    @When("^I post a limit reset withdrawal transaction and get response code as (\\d+)$")
    public void iPostALimitResetWithdrawalTransactionAndGetResponseCodeAs(int arg0) {
        ATMFinancialTxn atmFinancialTxn = new ATMFinancialTxn("1200", "6080140888812222", "011000", 5000, currentDate +" "+"23:49:00", txnId, currentDate + " "+ currentTime, "356", "71020171000C", "200", "6211", "810697", "000000415430", "235678", "RB0058080000000", "Pune", "356", "800000", "000008");
    ...
    public void iTurnOffTheLimitResetRule() {
